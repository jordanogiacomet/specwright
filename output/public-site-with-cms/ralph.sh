...
# ralph.sh — Story-by-story execution loop for Public site with cms
...
You are implementing a single story for the project **Public site with cms**.
...
echo ""
echo "=== Ralph Loop: Public site with cms ==="
echo "Stories: $TOTAL"
